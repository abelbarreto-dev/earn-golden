...
def upgrade() -> None:
    ...
    op.alter_column("cards", "due_date", format="YYYY-MM", nullable=False, type_=sa.Date())
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column("cards", "due_date", format="YYYY-MM-DD", nullable=False, type_=sa.Date())
    # ### end Alembic commands ###
